...
function preload() {
  img1 = loadImage("RollsRoyce.png");
  img2 = loadImage("Tesla.png");
  img3 = loadImage("kia seltos.png");
  img4 = loadImage("Swift.png");
